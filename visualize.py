...
import torch
from utils import visualize_filters, visualize_augmentation, visualize_activations, get_albumentations_transforms
import argparse
...
for mode in args.mode:
    if mode =='augmentation':
        ...
        layer=args.layer
        img_path=args.img_path
        visualize_activations(model, layer, img_path, get_albumentations_transforms(train=False), device)
        print(f"Running mode: {mode}")
